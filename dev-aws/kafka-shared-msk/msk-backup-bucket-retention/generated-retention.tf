...
resource "aws_s3_bucket_lifecycle_configuration" "msk_topics_retention" {
  ...
  rule {
    id     = "pubsub.restore-test.billing.bill-core-model"
    status = "Enabled"
    expiration { days = 31 }
    filter { prefix = "kafka-backup/pubsub.restore-test.billing.bill-core-model/" }
  }
  ...
  rule {
    id     = "pubsub.restore-test.billing.transaction-log-v3"
    status = "Enabled"
    expiration { days = 33 }
    filter { prefix = "kafka-backup/pubsub.restore-test.billing.transaction-log-v3/" }
  }
  ...
  rule {
    id     = "pubsub.restore-test.billing.unified-bill-report-events"
    status = "Enabled"
    expiration { days = 31 }
    filter { prefix = "kafka-backup/pubsub.restore-test.billing.unified-bill-report-events/" }
  }
  ...
  rule {
    id     = "pubsub.restore-test.cbc.PaymentEventsDeadLetter"
    status = "Enabled"
    expiration { days = 31 }
    filter { prefix = "kafka-backup/pubsub.restore-test.cbc.PaymentEventsDeadLetter/" }
  }

  rule {
    id     = "pubsub.restore-test.cbc.TopUpEventsDeadLetter"
    status = "Enabled"
    expiration { days = 31 }
    filter { prefix = "kafka-backup/pubsub.restore-test.cbc.TopUpEventsDeadLetter/" }
  }

  rule {
    id     = "pubsub.restore-test.contact-channels.auto_email_drafts"
    status = "Enabled"
    expiration { days = 31 }
    filter { prefix = "kafka-backup/pubsub.restore-test.contact-channels.auto_email_drafts/" }
  }
  ...
  rule {
    id     = "pubsub.restore-test.data-infra.bill-integration.bill-to-dex-comms-events"
    status = "Enabled"
    expiration { days = 31 }
    filter { prefix = "kafka-backup/pubsub.restore-test.data-infra.bill-integration.bill-to-dex-comms-events/" }
  }
  ...
  rule {
    id     = "pubsub.restore-test.data-infra.bill-integration.bill-to-unicom-events"
    status = "Enabled"
    expiration { days = 31 }
    filter { prefix = "kafka-backup/pubsub.restore-test.data-infra.bill-integration.bill-to-unicom-events/" }
  }
  ...
  rule {
    id     = "pubsub.restore-test.data-infra.bill-integration.test"
    status = "Enabled"
    expiration { days = 31 }
    filter { prefix = "kafka-backup/pubsub.restore-test.data-infra.bill-integration.test/" }
  }
  ...
  rule {
    id     = "pubsub.restore-test.data-infra.test"
    status = "Enabled"
    expiration { days = 31 }
    filter { prefix = "kafka-backup/pubsub.restore-test.data-infra.test/" }
  }

  rule {
    id     = "pubsub.restore-test.data-infra.uw.data-infra.product.v1.events"
    status = "Enabled"
    expiration { days = 2556 }
    filter { prefix = "kafka-backup/pubsub.restore-test.data-infra.uw.data-infra.product.v1.events/" }
  }
  ...
  rule {
    id     = "pubsub.restore-test.energy-platform.flow-files.events"
    status = "Enabled"
    expiration { days = 31 }
    filter { prefix = "kafka-backup/pubsub.restore-test.energy-platform.flow-files.events/" }
  }
  ...
  rule {
    id     = "pubsub.restore-test.energy-platform.gentrack.prepayment.events"
    status = "Enabled"
    expiration { days = 181 }
    filter { prefix = "kafka-backup/pubsub.restore-test.energy-platform.gentrack.prepayment.events/" }
  }
  ...
  rule {
    id     = "pubsub.restore-test.energy-platform.property.events"
    status = "Enabled"
    expiration { days = 181 }
    filter { prefix = "kafka-backup/pubsub.restore-test.energy-platform.property.events/" }
  }
  ...
  rule {
    id     = "pubsub.restore-test.payment-platform.payment.v1.public.events.due_bill_payment"
    status = "Enabled"
    expiration { days = 31 }
    filter { prefix = "kafka-backup/pubsub.restore-test.payment-platform.payment.v1.public.events.due_bill_payment/" }
  }

  rule {
    id     = "pubsub.restore-test.payment-platform.payment.v1.public.events.overdue_debt_logged_in"
    status = "Enabled"
    expiration { days = 31 }
    filter { prefix = "kafka-backup/pubsub.restore-test.payment-platform.payment.v1.public.events.overdue_debt_logged_in/" }
  }
  ...
  rule {
    id     = "pubsub.restore-test.unicom.di-kafka-source-notification"
    status = "Enabled"
    expiration { days = 181 }
    filter { prefix = "kafka-backup/pubsub.restore-test.unicom.di-kafka-source-notification/" }
  }
