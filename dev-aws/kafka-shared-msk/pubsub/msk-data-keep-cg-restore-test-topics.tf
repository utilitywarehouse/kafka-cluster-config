################################################################
# Restore-test copies of existing topics, used to test consumer-group
# restore at scale. Each topic below mirrors an existing topic's
# configuration (from its source file, noted in the comment), renamed
# under the "pubsub.restore-test." prefix so consumer groups on these
# topics can be restored/replayed without touching production data.
#
# Source topics were selected because their current size (Size +
# RemoteLogSizeBytes) is under 10GB, per:
# https://thanos.dev.aws.uw.systems/graph?g0.expr=sum%20(kafka_log_Log_Value%7Bjob%3D%22msk-shared%22%2C%20name%3D%22Size%22%7D)%20by%20(topic)%20%2B%20sum%20(kafka_server_BrokerTopicMetrics_Value%7Bname%3D%22RemoteLogSizeBytes%22%2C%20job%3D%22msk-shared%22%7D)%20by%20(topic)
################################################################

# --- account-identity ---

# source: account-identity/account.tf (account-identity.account-management-events, ~0.00MB)
...
# source: account-identity/account.tf (account-identity.account.atomic.v1, ~0.82MB)
...
# source: account-identity/account.tf (account-identity.account.events.v2, ~5.22MB)
...
# source: account-identity/exceptions.tf (account-identity.account.exceptions.v1, ~1844.15MB)
...
# source: account-identity/account.tf (account-identity.account.history.v1, ~0.43MB)
...
# source: account-identity/account.tf (account-identity.account.insights.events.v4, ~0.21MB)
...
# source: account-identity/address.tf (account-identity.address.lookup.analytics.v1, ~0.00MB)
...
# source: account-identity/exceptions.tf (account-identity.correspondence.address.debt.exception.check.events, ~690.12MB)
...
# source: account-identity/exceptions.tf (account-identity.correspondence.address.exception.check.events, ~689.32MB)
...
# source: account-identity/account.tf (account-identity.dev.account.events.anonymized.v0, ~0.34MB)
resource "kafka_topic" "restore_test_account_identity_dev_account_events_anonymized_v0" {
  config = {
    "remote.storage.enable" = "true"
    # keep data in primary storage for 1 day
    "local.retention.ms" = "86400000"
...
# source: account-identity/account.tf (account-identity.from-prod.account.events.anonymized.v0, ~5.79MB)
resource "kafka_topic" "restore_test_account_identity_from_prod_account_events_anonymized_v0" {
  config = {
    "remote.storage.enable" = "true"
    # keep data in primary storage for 1 day
    "local.retention.ms" = "86400000"
...
# source: account-identity/account.tf (account-identity.home-move.lifecycle.events.v1, ~0.01MB)
...
# source: account-identity/exceptions.tf (account-identity.land-registry.check.events, ~4.88MB)
...
# source: account-identity/legacy_account.tf (account-identity.legacy.account.created.in.bill.events, ~127.18MB)
...
# source: account-identity/legacy_account.tf (account-identity.legacy.account.eqdb.events, ~0.00MB)
...
# source: account-identity/legacy_account.tf (account-identity.legacy.account.events, ~2202.05MB)
resource "kafka_topic" "restore_test_account_identity_legacy_account_events" {
  config = {
    "cleanup.policy"   = "delete"
    "compression.type" = "zstd"
    # keep data forever
...
# source: account-identity/legacy_account.tf (account-identity.legacy.account.events.private, ~0.00MB)
...
# source: account-identity/account.tf (account-identity.public.account.events, ~0.31MB)
...
# source: account-identity/okta.tf (account-identity.staff.okta.v6, ~548.24MB)
...
# source: account-identity/exceptions.tf (account-identity.supply.address.debt.exception.check.events, ~689.87MB)
...
# source: account-identity/exceptions.tf (account-identity.supply.address.exception.check.events, ~0.00MB)
resource "kafka_topic" "restore_test_account_identity_supply_address_exception_check_events" {
  config = {
    "cleanup.policy" = "delete"
    # enable remote storage
    "remote.storage.enable" = "true"
...
# source: account-identity/account.tf (account-identity.to.anonymize, ~0.53MB)
...
# source: account-identity/verification.tf (account-identity.verification.events.v1, ~0.33MB)
...
# source: billing/data-staged-events.tf (billing.DataStagedEventsFinance, ~1847.74MB)
...
# source: billing/billing.tf (billing.bill-core-model, ~158.99MB)
...
# source: billing/billing.tf (billing.bill-reconciliation-error-events, ~124.43MB)
...
# source: billing/billing.tf (billing.energy-raw-data-reconciliation-diff, ~0.01MB)
...
# source: billing/data-staged-events.tf (billing.historical-data-staged-events-finance, ~0.15MB)
...
# source: billing/transaction-log.tf (billing.transaction-log-v3, ~6927.90MB)
...
# source: billing/transaction-auditor-events.tf (billing.transactions-auditor-diff.events, ~0.00MB)
...
# source: billing/billing.tf (billing.unified-bill-ready-events, ~0.01MB)
...
# source: billing/billing.tf (billing.unified-bill-report-events, ~0.00MB)
...
# source: cbc/cbc.tf (cbc.ChallengeEvents, ~0.03MB)
...
# source: cbc/cbc.tf (cbc.ChargesEvents, ~108.01MB)
...
# source: cbc/cbc.tf (cbc.CrmEvents, ~13.12MB)
...
# source: cbc/cbc.tf (cbc.CustomerEvents, ~259.68MB)
...
# source: cbc/cbc.tf (cbc.DataProductEvents, ~0.00MB)
...
# source: cbc/cbc.tf (cbc.EqdbLoaderEvents, ~0.00MB)
...
# source: cbc/cbc.tf (cbc.FraudEvents, ~6.79MB)
...
# source: cbc/cbc.tf (cbc.LifecycleEvents_v2, ~70.31MB)
...
# source: cbc/cbc.tf (cbc.MdesEvents, ~0.01MB)
...
# source: cbc/cbc.tf (cbc.MigrationEvents, ~0.00MB)
...
# source: cbc/cbc.tf (cbc.NetworkEvents, ~0.01MB)
...
# source: cbc/cbc.tf (cbc.OpenBankingEvents, ~0.00MB)
...
# source: cbc/cbc.tf (cbc.OrderEvents, ~18.52MB)
...
# source: cbc/cbc.tf (cbc.PaymentEventsDeadLetter, ~0.00MB)
...
# source: cbc/cbc.tf (cbc.PaymentologyNotificationEvents, ~0.36MB)
resource "kafka_topic" "restore_test_paymentology_events_v1" {
...
# source: cbc/cbc.tf (cbc.RatingEvents_v3, ~0.04MB)
...
# source: cbc/cbc.tf (cbc.ServiceEvents, ~8.04MB)
...
# source: cbc/cbc.tf (cbc.SodexoEvents, ~0.05MB)
...
# source: cbc/cbc.tf (cbc.TopUpEvents, ~5.50MB)
...
# source: cbc/cbc.tf (cbc.TopUpEventsDeadLetter, ~0.00MB)
...
# source: cbc/cbc.tf (cbc.TransactionEvents_v3, ~17.28MB)
resource "kafka_topic" "restore_test_transaction_events_v3" {
...
# source: cbc/cbc.tf (cbc.VerificationEvents, ~29.20MB)
...
# source: cbc/cbc.tf (cbc.legacy.account.events.v2, ~2269.12MB)
resource "kafka_topic" "restore_test_legacy_account_events_v2" {
...
# source: contact-channels/contact-channels.tf (contact-channels.auto_email_drafts, ~0.01MB)
...
# source: contact-channels/contact-channels.tf (contact-channels.dsar, ~0.00MB)
...
# source: contact-channels/contact-channels.tf (contact-channels.dsar_conversation, ~0.00MB)
...
# source: contact-channels/contact-channels.tf (contact-channels.dsar_job, ~0.00MB)
...
# source: contact-channels/contact-channels.tf (contact-channels.genesys_eb_events, ~0.05MB)
resource "kafka_topic" "restore_test_genesys_eb_events" {
...
# source: customer-billing/topics.tf (bex.internal.accountreadytobefulfilled_deadletter, ~0.00MB)
...
# source: customer-billing/topics.tf (bex.internal.bill_fulfilled, ~0.00MB)
...
# source: customer-billing/topics.tf (bex.internal.bill_regeneration, ~0.00MB)
...
# source: customer-billing/topics.tf (bex.internal.bill_regeneration_deadletter, ~0.00MB)
...
# source: customer-billing/topics.tf (bex.internal.bill_regeneration_large_invoice, ~0.00MB)
...
# source: customer-billing/topics.tf (bex.internal.bill_regeneration_retry_1, ~0.00MB)
...
# source: customer-billing/topics.tf (bex.internal.bill_regeneration_retry_2, ~0.00MB)
...
# source: customer-billing/topics.tf (bex.internal.email_sender_deadletter, ~0.00MB)
...
# source: customer-billing/topics.tf (bex.internal.exstream_invoice_produced, ~13.69MB)
...
# source: customer-billing/topics.tf (bex.internal.fulfilment_deadletter, ~0.00MB)
...
# source: customer-billing/topics.tf (bex.internal.fulfilment_large_invoice, ~0.00MB)
...
# source: customer-billing/topics.tf (bex.internal.fulfilment_retry_1, ~0.00MB)
...
# source: customer-billing/topics.tf (bex.internal.fulfilment_retry_2, ~0.00MB)
...
# source: customer-billing/topics.tf (bex.internal.invoice_ready_notifier_deadletter, ~0.00MB)
...
# source: customer-billing/topics.tf (bex.internal.mail_sender_deadletter, ~0.00MB)
...
# source: customer-billing/topics.tf (bex.internal.mail_sender_reprint_deadletter, ~0.00MB)
...
# source: customer-billing/topics.tf (bex.public.fulfilment_events, ~0.00MB)
...
# source: customer-billing/topics.tf (bex.transition.fulfilment_request, ~0.00MB)
...
# source: customer-proposition/bundle-tier.tf (customer-proposition.public.bundletier.events.v1, ~320.34MB)
...
# source: customer-proposition/bundle-tier.tf (customer-proposition.public.bundletier.events.v2, ~95.74MB)
...
# source: customer-proposition/customer-proposition.tf (customer-proposition.service-status.events.deadletter.v4, ~598.52MB)
...
# source: customer-proposition/customer-proposition.tf (customer-proposition.uswitch.data.v1, ~1.89MB)
...
# source: customer-proposition/customer-proposition.tf (customer-proposition.uswitch.events.v2, ~4.55MB)
...
# source: customer-support/coffee.tf (customer-support.coffee_account_history_v1, ~0.00MB)
...
# source: customer-support/coffee.tf (customer-support.coffee_services, ~0.00MB)
...
# source: customer-support/william.tf (customer-support.notes_v2, ~4.52MB)
...
# source: customer-support/payments.tf (customer-support.payments_audit_log_v1, ~0.02MB)
...
# source: customer-support/reminders.tf (customer-support.reminders_v1, ~23.30MB)
...
# source: customer-support/william.tf (customer-support.ticketing_v2, ~8.52MB)
...
# source: customer-support/vulnerability.tf (customer-support.vulnerability_v7, ~20.71MB)
resource "kafka_topic" "restore_test_vulnerability_v7" {
  config = {
    "cleanup.policy" = "delete"
    # Recommended by dev-ena
    "compression.type" = "zstd"
...
# source: data-infra/bill-integration.tf (data-infra.bill-integration.bill-telemetry, ~0.00MB)
...
# source: data-infra/bill-integration.tf (data-infra.bill-integration.bill-to-dex-comms-events, ~0.00MB)
resource "kafka_topic" "restore_test_bill_to_dex_comms_events" {
  name               = "pubsub.restore-test.data-infra.bill-integration.bill-to-dex-comms-events"
  replication_factor = 3
  partitions         = 15
  config = {
    "remote.storage.enable" = "true"
...
# source: data-infra/bill-integration.tf (data-infra.bill-integration.bill-to-kubernetes, ~134.98MB)
...
# source: data-infra/bill-integration.tf (data-infra.bill-integration.bill-to-unicom-events, ~0.00MB)
resource "kafka_topic" "restore_test_bill_to_unicom_events" {
  name               = "pubsub.restore-test.data-infra.bill-integration.bill-to-unicom-events"
  replication_factor = 3
  partitions         = 15
  config = {
    "remote.storage.enable" = "true"
...
# source: data-infra/bill-integration.tf (data-infra.bill-integration.kubernetes-to-bill, ~4.17MB)
...
# source: data-infra/bill-integration.tf (data-infra.bill-integration.kubernetes-to-bill-energy-meter-reading, ~0.00MB)
...
# source: data-infra/bill-integration.tf (data-infra.bill-integration.test, ~0.00MB)
resource "kafka_topic" "restore_test_bill_integration_test" {
  name               = "pubsub.restore-test.data-infra.bill-integration.test"
  replication_factor = 3
  partitions         = 15
  config = {
    "remote.storage.enable" = "true"
...
# source: data-infra/bill-integration.tf (data-infra.bill_event_bridge.dlq, ~0.00MB)
...
# source: data-infra/connectors.tf (data-infra.product.v1.events.dlq, ~0.54MB)
...
# source: data-infra/connectors.tf (data-infra.product.v1.events.dlq.alerts, ~0.00MB)
...
# source: data-infra/connectors.tf (data-infra.product.v1.events.requeue, ~0.55MB)
...
# source: data-infra/test.tf (data-infra.test, ~0.00MB)
resource "kafka_topic" "restore_test_test" {
  name               = "pubsub.restore-test.data-infra.test"
  replication_factor = 3
  partitions         = 15
  config = {
    "remote.storage.enable" = "true"
...
# source: data-infra/api.tf (data-infra.uw.data-infra.product.v1.events, ~3483.37MB)
resource "kafka_topic" "restore_test_events" {
...
# source: data-infra/connectors.tf (data-infra.uw.data-infra.product.v1.eventsend, ~329.60MB)
...
# source: energy-billing/topics.tf (energy-billing.electronic_payment.events, ~0.49MB)
...
# source: energy-billing/topics.tf (energy-billing.internal.billing-adapter-deadletter, ~0.00MB)
...
# source: energy-billing/topics.tf (energy-billing.internal.billing-adapter-retry-1, ~0.00MB)
...
# source: energy-billing/topics.tf (energy-billing.internal.billing-adapter-retry-2, ~0.00MB)
...
# source: energy-platform/flow_files.tf (energy-platform.flow-files.events, ~0.00MB)
...
# source: energy-platform/gentrack.tf (energy-platform.gentrack.billing.events, ~0.01MB)
...
# source: energy-platform/gentrack.tf (energy-platform.gentrack.electronic_payment.events, ~0.60MB)
...
# source: energy-platform/gentrack.tf (energy-platform.gentrack.market_interactions.events, ~9.64MB)
...
# source: energy-platform/gentrack.tf (energy-platform.gentrack.meter.read.events, ~7.93MB)
...
# source: energy-platform/gentrack.tf (energy-platform.gentrack.meterpoint.events, ~534.72MB)
...
# source: energy-platform/gentrack.tf (energy-platform.gentrack.migration.events, ~106.02MB)
...
# source: energy-platform/gentrack.tf (energy-platform.gentrack.prepayment.events, ~0.01MB)
...
# source: energy-platform/meter-reads.tf (energy-platform.meter.read.events.v3, ~52.27MB)
resource "kafka_topic" "restore_test_meter_reads" {
...
# source: energy-platform/properties.tf (energy-platform.property.events, ~0.00MB)
...
# source: energy-platform/properties.tf (energy-platform.property.migration.events, ~1.77MB)
...
# source: energy-platform/tariffs.tf (energy-platform.tariff.events, ~0.04MB)
...
# source: finance/sledger-fabricator.tf (finance.fabricator.sledger.entries.v1, ~0.00MB)
...
# source: help-and-support/self-serve.tf (help-and-support.self_serve_submissions, ~0.02MB)
...
# source: help-and-support/self-serve.tf (help-and-support.self_serve_submissions_dlq, ~0.00MB)
...
# source: iam/iam.tf (auth-customer.iam-credentials-v1, ~119.76MB)
...
# source: iam/iam.tf (auth-customer.iam-credentials-v1-public, ~3.03MB)
...
# source: iam/iam.tf (auth-customer.iam-dpd-v1, ~17.87MB)
...
# source: iam/iam.tf (auth.iam-identitydb-v1, ~34.64MB)
...
# source: iam/iam.tf (auth.iam-revoked-v1, ~0.55MB)
...
# source: iam-audit/iam.tf (iam-audit.ingest-v1, ~0.00MB)
resource "kafka_topic" "restore_test_ingest_v1" {
...
# source: insurance/backup.tf (insurance.private.policies.v1, ~34.49MB)
...
# source: insurance/insurance.tf (insurance.public.policies.v1, ~12.41MB)
...
# source: ledgers/ledger.tf (ledgers.account-balance.events, ~0.00MB)
...
# source: ledgers/ledger.tf (ledgers.transaction.events, ~0.00MB)
...
# source: partner-commission/partner-commission.tf (partner-commission.es.demo.v1, ~0.00MB)
resource "kafka_topic" "restore_test_es_demo_v1" {
...
# source: payment-platform/card.tf (payment-platform.card-deadletter.v1.internal, ~0.00MB)
...
# source: payment-platform/card.tf (payment-platform.card-deadletter.v1.internal.payment-methods, ~0.00MB)
...
# source: payment-platform/card.tf (payment-platform.card.v1.internal, ~0.81MB)
...
# source: payment-platform/card.tf (payment-platform.card.v1.internal.notifications, ~3.77MB)
...
# source: payment-platform/card.tf (payment-platform.card.v1.internal.payment-methods, ~0.00MB)
...
# source: payment-platform/notifications-raw.tf (payment-platform.notifications.stripe.raw, ~0.00MB)
...
# source: payment-platform/notifications-tx.tf (payment-platform.notifications.tx, ~0.00MB)
...
# source: payment-platform/notifications-raw.tf (payment-platform.notifications.worldpay.raw, ~0.00MB)
...
# source: payment-platform/open-banking.tf (payment-platform.openbanking-deadletter.v1.internal.payment-methods, ~0.00MB)
...
# source: payment-platform/open-banking.tf (payment-platform.openbanking-deadletter.v1.internal.payments, ~0.00MB)
...
# source: payment-platform/open-banking.tf (payment-platform.openbanking-deadletter.v1.internal.settlements, ~0.00MB)
...
# source: payment-platform/open-banking.tf (payment-platform.openbanking.v1.internal.payment-methods, ~0.00MB)
...
# source: payment-platform/open-banking.tf (payment-platform.openbanking.v1.internal.payments, ~0.00MB)
...
# source: payment-platform/open-banking.tf (payment-platform.openbanking.v1.internal.settlements, ~0.00MB)
...
# source: payment-platform/payment-analysis.tf (payment-platform.payment-analysis.payment-method, ~0.00MB)
...
# source: payment-platform/payment.tf (payment-platform.payment-deadletter.v1.events, ~1.80MB)
...
# source: payment-platform/payment.tf (payment-platform.payment-method-deadletter.v1.events, ~0.00MB)
...
# source: payment-platform/payment.tf (payment-platform.payment-method.v1.events, ~0.02MB)
...
# source: payment-platform/payment.tf (payment-platform.payment-method.v1.public.events, ~0.02MB)
...
# source: payment-platform/data-staged.tf (payment-platform.payment.data-staged, ~51.15MB)
...
# source: payment-platform/payment-enriched-txs.tf (payment-platform.payment.enriched-txs, ~0.00MB)
...
# source: payment-platform/reconciliation.tf (payment-platform.payment.gateway.reconciliation, ~0.04MB)
...
# source: payment-platform/reconciliation.tf (payment-platform.payment.gateway.reconciliation.status-changed, ~4.09MB)
...
# source: payment-platform/card-payment.tf (payment-platform.payment.method-created, ~0.00MB)
...
# source: payment-platform/card-payment.tf (payment-platform.payment.method-linked, ~0.00MB)
...
# source: payment-platform/card-payment.tf (payment-platform.payment.method-verified, ~0.00MB)
...
# source: payment-platform/card-payment.tf (payment-platform.payment.payment, ~0.00MB)
...
# source: payment-platform/payment.tf (payment-platform.payment.v1.events, ~4.28MB)
...
# source: payment-platform/payment.tf (payment-platform.payment.v1.public.events, ~3.69MB)
...
# source: payment-platform/payment.tf (payment-platform.payment.v1.public.events.cbc_topup_v3, ~0.00MB)
...
# source: payment-platform/payment.tf (payment-platform.payment.v1.public.events.debt, ~2.12MB)
...
# source: payment-platform/payment.tf (payment-platform.payment.v1.public.events.debt_payment_plan, ~0.01MB)
...
# source: payment-platform/payment.tf (payment-platform.payment.v1.public.events.due_bill_payment, ~0.13MB)
...
# source: payment-platform/payment.tf (payment-platform.payment.v1.public.events.overdue_debt_logged_in, ~0.03MB)
...
# source: payment-platform/payment.tf (payment-platform.payment.v1.public.events.pp_test, ~1.33MB)
...
# source: quoting-platform/quoting-platform.tf (quoting-platform.basket.events.v1, ~34.60MB)
...
# source: unicom/topics.tf (unicom.bill-events, ~286.53MB)
...
# source: unicom/topics.tf (unicom.bill-failed, ~0.00MB)
...
# source: unicom/topics.tf (unicom.bounce.2019.1, ~0.11MB)
...
# source: unicom/topics.tf (unicom.braze_backfill, ~0.00MB)
...
# source: unicom/topics.tf (unicom.cancel-status.1, ~0.05MB)
resource "kafka_topic" "restore_test_unicom_cancel_status_1" {
...
# source: unicom/topics.tf (unicom.cancellation.1, ~1.69MB)
...
# source: unicom/topics.tf (unicom.caps, ~0.00MB)
...
# source: unicom/topics.tf (unicom.caps-consent, ~16.95MB)
...
# source: unicom/topics.tf (unicom.clx-report, ~3.26MB)
...
# source: unicom/topics.tf (unicom.comms-api-requests, ~189.50MB)
...
# source: unicom/topics.tf (unicom.comms-fallback.1, ~0.00MB)
...
# source: unicom/topics.tf (unicom.cost-calculated.1, ~175.76MB)
...
# source: unicom/topics.tf (unicom.di-kafka-source-notification, ~0.01MB)
...
# source: unicom/topics.tf (unicom.email-batch.1, ~0.00MB)
...
# source: unicom/topics.tf (unicom.email-post-delivery.1, ~5.25MB)
...
# source: unicom/topics.tf (unicom.email-released-critical.1, ~0.50MB)
...
# source: unicom/topics.tf (unicom.email-released-important.1, ~2.83MB)
...
# source: unicom/topics.tf (unicom.email-released-mock-critical.1, ~0.00MB)
resource "kafka_topic" "restore_test_unicom_email_released_mock_critical_1" {
...
# source: unicom/topics.tf (unicom.email-released-mock-important.1, ~0.00MB)
resource "kafka_topic" "restore_test_unicom_email_released_mock_important_1" {
...
# source: unicom/topics.tf (unicom.email-released-ses-critical.1, ~4.92MB)
resource "kafka_topic" "restore_test_unicom_email_released_ses_critical_1" {
...
# source: unicom/topics.tf (unicom.email-released-ses-important.1, ~2.39MB)
resource "kafka_topic" "restore_test_unicom_email_released_ses_important_1" {
...
# source: unicom/topics.tf (unicom.email-released-ses.1, ~38.30MB)
resource "kafka_topic" "restore_test_unicom_email_released_ses_1" {
...
# source: unicom/topics.tf (unicom.email-released.1, ~287.87MB)
...
# source: unicom/topics.tf (unicom.email-status.1, ~4308.34MB)
...
# source: unicom/topics.tf (unicom.failed, ~4.55MB)
...
# source: unicom/topics.tf (unicom.go-inspire-letter-status.1, ~0.00MB)
...
# source: unicom/topics.tf (unicom.letter-batch-critical.1, ~0.00MB)
...
# source: unicom/topics.tf (unicom.letter-batch-important.1, ~0.00MB)
...
# source: unicom/topics.tf (unicom.letter-batch.1, ~0.00MB)
...
# source: unicom/topics.tf (unicom.letter-released-critical.1, ~0.01MB)
...
# source: unicom/topics.tf (unicom.letter-released-important.1, ~0.05MB)
...
# source: unicom/topics.tf (unicom.letter-released-mock-critical.1, ~0.00MB)
resource "kafka_topic" "restore_test_unicom_letter_released_mock_critical_1" {
...
# source: unicom/topics.tf (unicom.letter-released-mock-important.1, ~0.00MB)
resource "kafka_topic" "restore_test_unicom_letter_released_mock_important_1" {
...
# source: unicom/topics.tf (unicom.letter-released-mock.1, ~0.00MB)
resource "kafka_topic" "restore_test_unicom_letter_released_mock_1" {
...
# source: unicom/topics.tf (unicom.letter-released.1, ~60.08MB)
...
# source: unicom/topics.tf (unicom.letter-send-adare, ~32.76MB)
...
# source: unicom/topics.tf (unicom.letter-status.1, ~24.35MB)
...
# source: unicom/topics.tf (unicom.mparticle-output-integration, ~0.00MB)
...
# source: unicom/topics.tf (unicom.orchestration-entity.1, ~0.00MB)
...
# source: unicom/topics.tf (unicom.orchestration-rule-execution.1, ~0.00MB)
...
# source: unicom/topics.tf (unicom.outbound-call-request, ~0.00MB)
...
# source: unicom/topics.tf (unicom.push-notification-released.1, ~0.00MB)
...
# source: unicom/topics.tf (unicom.push-notification-status.1, ~0.00MB)
...
# source: unicom/topics.tf (unicom.rejected, ~0.00MB)
...
# source: unicom/topics.tf (unicom.rendered.1, ~246.60MB)
...
# source: unicom/topics.tf (unicom.requests, ~0.00MB)
...
# source: unicom/topics.tf (unicom.scheduled.1, ~3.94MB)
...
# source: unicom/topics.tf (unicom.send-notification.1, ~0.00MB)
...
# source: unicom/topics.tf (unicom.sftp-status, ~23.39MB)
...
# source: unicom/topics.tf (unicom.sms-batch.1, ~0.00MB)
...
# source: unicom/topics.tf (unicom.sms-released-critical.1, ~0.13MB)
...
# source: unicom/topics.tf (unicom.sms-released-important.1, ~0.00MB)
...
# source: unicom/topics.tf (unicom.sms-released.1, ~5.05MB)
...
# source: unicom/topics.tf (unicom.sms-status.1, ~3.56MB)
...
# source: unicom/topics.tf (unicom.status, ~694.61MB)
resource "kafka_topic" "restore_test_unicom_status" {
...
# source: unicom/topics.tf (unicom.status-bill-email-connector, ~0.00MB)
...
# source: unicom/topics.tf (unicom.status-energy-smets1-notifier, ~0.00MB)
...
# source: unicom/topics.tf (unicom.status-finance-email-delivery-engine, ~0.00MB)
...
# source: unicom/topics.tf (unicom.status-v2, ~588.70MB)
resource "kafka_topic" "restore_test_unicom_status_v2" {
...
# source: unicom/topics.tf (unicom.tests, ~3246.89MB)
resource "kafka_topic" "restore_test_unicom_tests" {
