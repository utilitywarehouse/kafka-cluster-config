...
# Allow help-and-support's william-ticket-genesys-queuer to consume from `customer-support.ticketing_v2`.
module "help_and_support_william_ticket_genesys_queuer" {
  source           = "../../../modules/tls-app"
