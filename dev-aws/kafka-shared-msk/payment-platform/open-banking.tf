...
module "openbanking_apid" {
  ...
  produce_topics   = [kafka_topic.openbanking_v1_internal_payments.name, kafka_topic.openbanking_v1_internal_payment_methods.name]
  cert_common_name = "payment-platform/openbanking-apid"
}

module "openbanking_consumerd" {
  source           = "../../../modules/tls-app"
  produce_topics   = [kafka_topic.openbanking_deadletter_v1_internal_payments.name, kafka_topic.openbanking_deadletter_v1_internal_payment_methods.name]
