module "account_identity_proximo" {
  ...
  consume_groups = ["account-identity.finance-legacy-account-api", "account-identity.insurance-legacy-account-kafka-relay", "account-identity.caps-citizen-creator", "account-identity.dex-account-management-projector-2022-07-22-management-events-dev", "account-identity.debt-collection-comms-api-accounts", "account-identity.customer-incentives.legacy-accounts-adapter-03", "account-identity.public-api-v1",
    "account-identity.ordering-platform-adapter", "account-identity.leads-api-indexer-v1", "account-identity.dex-timeline-emailer-basia1", "account-identity.customer-support.idv.projector-001", "account-identity.finance-legacy-account-api-occupancy-type-reconsumer",
