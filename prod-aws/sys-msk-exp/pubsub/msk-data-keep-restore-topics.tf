################################################################
# Restore-test topics: copies of all production topics under
# prod-aws/kafka-shared-msk, prefixed with "pubsub.restore-test."
# so they can be used to test the restore process without touching
# the real production topics.
################################################################
...
resource "kafka_topic" "restore_test_account_identity_account_unified_events" {
  config = {
...
resource "kafka_topic" "restore_test_account_identity_account_management_events_green" {
  config = {
    "cleanup.policy"   = "delete"
    "compression.type" = "zstd"
    # keep data in primary storage for 1 day
...
resource "kafka_topic" "restore_test_account_identity_to_anonymize" {
  config = {
    "cleanup.policy"   = "delete"
    "compression.type" = "zstd"
    # keep data in primary storage for 1 day
...
resource "kafka_topic" "restore_test_account_identity_account_bill_writes_public" {
  config = {
    "cleanup.policy" = "compact"
    # allow not compacted keys maximum for 7 days
    "max.compaction.lag.ms" = "604800000"
...
resource "kafka_topic" "restore_test_account_identity_account_exceptions_events" {
  config = {
    "compression.type" = "zstd"
    "cleanup.policy"   = "compact"
...
resource "kafka_topic" "restore_test_account_identity_finance_events_compacted" {
  config = {
    "cleanup.policy"   = "compact"
    "compression.type" = "zstd"
    # allow not compacted keys maximum for 7 days
...
resource "kafka_topic" "restore_test_account_identity_account_change_events" {
  config = {
    "cleanup.policy"   = "compact"
    "compression.type" = "zstd"
    # allow not compacted keys maximum for 7 days
...
resource "kafka_topic" "restore_test_account_identity_check_events" {
  config = {
    "cleanup.policy"   = "compact"
    "compression.type" = "zstd"
    # allow not compacted keys maximum for 7 days
...
resource "kafka_topic" "restore_test_account_identity_check_status_events" {
  config = {
    "cleanup.policy"   = "compact"
    "compression.type" = "zstd"
    # allow not compacted keys maximum for 7 days
...
resource "kafka_topic" "restore_test_account_identity_legacy_account_holder_events_compacted" {
...
resource "kafka_topic" "restore_test_account_identity_legacy_account_events_compacted" {
  config = {
    "cleanup.policy"   = "compact"
...
resource "kafka_topic" "restore_test_account_identity_legacy_account_changelog_events" {
  config = {
    "cleanup.policy"   = "compact"
    "compression.type" = "zstd"
...
resource "kafka_topic" "restore_test_account_identity_legacy_account_change_events_compacted" {
  config = {
    "cleanup.policy" = "compact"
...
resource "kafka_topic" "restore_test_account_identity_legacy_account_braze_events_compacted" {
  config = {
    "cleanup.policy" = "compact"
    # allow not compacted keys maximum for 7 days
    "max.compaction.lag.ms" = "604800000"
...
resource "kafka_topic" "restore_test_account_identity_internal_legacy_account_events" {
  config = {
    "cleanup.policy" = "compact"
    # allow not compacted keys maximum for 7 days
    "max.compaction.lag.ms" = "604800000"
...
resource "kafka_topic" "restore_test_account_identity_verification_events_v1" {
  config = {
    "cleanup.policy"   = "delete"
    "compression.type" = "zstd"
    # keep data in primary storage for 1 day
...
resource "kafka_topic" "restore_test_contact_channels_auto_email_drafts" {
...
resource "kafka_topic" "restore_test_bex_internal_bill_fulfilled" {
...
resource "kafka_topic" "restore_test_bex_internal_accountreadytobefulfilled_deadletter" {
...
resource "kafka_topic" "restore_test_bex_internal_fulfilment_deadletter" {
...
resource "kafka_topic" "restore_test_bex_internal_mail_sender_deadletter" {
...
resource "kafka_topic" "restore_test_bex_internal_email_sender_deadletter" {
...
resource "kafka_topic" "restore_test_bex_internal_mail_sender_reprint_deadletter" {
...
resource "kafka_topic" "restore_test_bex_internal_invoices" {
...
resource "kafka_topic" "restore_test_bex_internal_invoice_ready_notifier_deadletter" {
...
resource "kafka_topic" "restore_test_bex_internal_bex_invoice_produced" {
...
resource "kafka_topic" "restore_test_bex_internal_exstream_invoice_produced" {
...
resource "kafka_topic" "restore_test_bex_public_fulfilment_events" {
...
resource "kafka_topic" "restore_test_bex_transition_fulfilment_request" {
...
resource "kafka_topic" "restore_test_bex_internal_fulfilment_retry_1" {
...
resource "kafka_topic" "restore_test_bex_internal_fulfilment_retry_2" {
...
resource "kafka_topic" "restore_test_bex_internal_fulfilment_large_invoice" {
...
resource "kafka_topic" "restore_test_bex_internal_bill_regeneration" {
...
resource "kafka_topic" "restore_test_bex_internal_bill_regeneration_retry_1" {
...
resource "kafka_topic" "restore_test_bex_internal_bill_regeneration_retry_2" {
...
resource "kafka_topic" "restore_test_bex_internal_bill_regeneration_large_invoice" {
...
resource "kafka_topic" "restore_test_bex_internal_bill_regeneration_deadletter" {
...
resource "kafka_topic" "restore_test_customer_proposition_public_bundletier_events_compacted_v1" {
...
resource "kafka_topic" "restore_test_customer_proposition_public_bundletier_events_v1" {
...
resource "kafka_topic" "restore_test_customer_proposition_public_bundletier_events_compacted_v2" {
...
resource "kafka_topic" "restore_test_customer_proposition_public_bundletier_events_v2" {
...
resource "kafka_topic" "restore_test_customer_proposition_service_status_events_v4" {
...
resource "kafka_topic" "restore_test_customer_proposition_service_status_events_deadletter_v4" {
...
resource "kafka_topic" "restore_test_customer_support_vulnerability_v6" {
  config = {
    "cleanup.policy" = "delete"
    # Recommended by dev-ena
    "compression.type" = "zstd"
...
resource "kafka_topic" "restore_test_data_infra_uw_data_infra_product_v1_events" {
...
resource "kafka_topic" "restore_test_data_infra_uw_data_infra_product_v1_eventsend" {
...
resource "kafka_topic" "restore_test_data_infra_product_v1_events_requeue" {
...
resource "kafka_topic" "restore_test_data_infra_product_v1_events_dlq" {
...
resource "kafka_topic" "restore_test_data_infra_product_v1_events_dlq_alerts" {
...
resource "kafka_topic" "restore_test_data_infra_uw_data_infra_pubsubbrige_snowplow" {
...
resource "kafka_topic" "restore_test_energy_billing_internal_billing_adapter_deadletter" {
...
resource "kafka_topic" "restore_test_energy_billing_internal_billing_adapter_retry_1" {
...
resource "kafka_topic" "restore_test_energy_billing_internal_billing_adapter_retry_2" {
...
resource "kafka_topic" "restore_test_energy_platform_flow_files_events" {
...
resource "kafka_topic" "restore_test_energy_platform_gentrack_prepayment_events" {
...
resource "kafka_topic" "restore_test_energy_platform_meter_read_events_v2" {
  name               = "pubsub.restore-test.energy-platform.meter.read.events.v2"
  replication_factor = 3
  partitions         = 15
  config = {
    # Use tiered storage
...
resource "kafka_topic" "restore_test_energy_platform_property_events" {
...
resource "kafka_topic" "restore_test_auth_iam_click_v2" {
...
resource "kafka_topic" "restore_test_auth_iam_cerbos_audit_v1" {
...
resource "kafka_topic" "restore_test_auth_customer_iam_credentials_v1" {
...
resource "kafka_topic" "restore_test_auth_customer_iam_dpd_v1" {
...
resource "kafka_topic" "restore_test_auth_iam_identitydb_v1" {
...
resource "kafka_topic" "restore_test_auth_iam_revoked_v1" {
...
resource "kafka_topic" "restore_test_auth_customer_iam_credentials_v1_public" {
...
resource "kafka_topic" "restore_test_insurance_private_accounts_v1" {
...
resource "kafka_topic" "restore_test_insurance_private_accounts_v2" {
...
resource "kafka_topic" "restore_test_insurance_private_claims_v1" {
...
resource "kafka_topic" "restore_test_insurance_private_comms_v1" {
...
resource "kafka_topic" "restore_test_insurance_private_coverage_v1" {
...
resource "kafka_topic" "restore_test_insurance_private_documents_v1" {
...
resource "kafka_topic" "restore_test_insurance_private_durell_edi_v1" {
...
resource "kafka_topic" "restore_test_insurance_private_eligibility_v1" {
...
resource "kafka_topic" "restore_test_insurance_private_renewal_dates_v1" {
...
resource "kafka_topic" "restore_test_insurance_private_policy_prices_v1" {
...
resource "kafka_topic" "restore_test_insurance_private_quotes_v1" {
...
resource "kafka_topic" "restore_test_ledgers_reconciliation_events" {
...
resource "kafka_topic" "restore_test_ledgers_data_migration_events" {
...
resource "kafka_topic" "restore_test_payment_platform_payment_v1_public_events_overdue_debt_logged_in" {
...
resource "kafka_topic" "restore_test_payment_platform_payment_v1_public_events_due_bill_payment" {
...
resource "kafka_topic" "restore_test_quoting_platform_basket_events_v1" {
...
resource "kafka_topic" "restore_test_staging_ept_gentrack_meter_read_events" {
  name               = "pubsub.restore-test.staging-ept.gentrack.meter.read.events"
  replication_factor = 3
  partitions         = 3
...
resource "kafka_topic" "restore_test_staging_ept_gentrack_market_interactions_events" {
  name               = "pubsub.restore-test.staging-ept.gentrack.market_interactions.events"
  replication_factor = 3
  partitions         = 3
  # Ephemeral staging topic: carries messages transiently (~5 min), no tiered/cold storage.
  config = {
...
resource "kafka_topic" "restore_test_staging_ept_meter_read_events_v2" {
  name               = "pubsub.restore-test.staging-ept.meter.read.events.v2"
  replication_factor = 3
  partitions         = 3
  # Ephemeral staging topic: carries messages transiently (~5 min), no tiered/cold storage.
  config = {
...
resource "kafka_topic" "restore_test_workplace_infrastructure_netapp_audit_v1_svm_cifs_a" {
  name               = "pubsub.restore-test.workplace-infrastructure.netapp-audit-v1.svm_cifs_a"
  replication_factor = 3
  partitions         = 10
  config = {
...
resource "kafka_topic" "restore_test_workplace_infrastructure_netapp_audit_v1_svm_cifs_b" {
  name               = "pubsub.restore-test.workplace-infrastructure.netapp-audit-v1.svm_cifs_b"
  replication_factor = 3
  partitions         = 10
  config = {
    "retention.bytes"   = "209715200" # keep on each partition 200MiB
