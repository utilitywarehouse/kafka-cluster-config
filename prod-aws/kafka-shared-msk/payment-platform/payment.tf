...
module "payment_query_service_downstream" {
  ...
  consume_groups   = ["payment-platform.payment_query_service_downstream", "payment-platform.payment_query_service_downstream_sync", "payment-platform.payment_query_service_downstream_txlog"]
